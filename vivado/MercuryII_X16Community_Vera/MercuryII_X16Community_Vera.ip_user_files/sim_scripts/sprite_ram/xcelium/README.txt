...
#
# Generated by export_simulation on Thu Oct 19 20:35:20 -0700 2023
#
################################################################################
...
'-reset_run' switch to the './sprite_ram.sh' script.

./sprite_ram.sh -reset_run
...
./sprite_ram.sh -noclean_files

For more information on the script, please type './sprite_ram.sh -help'.
